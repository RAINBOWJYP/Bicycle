...
public class ServerActivity1 {

    private final String TAG = "ServerActivity1";
    ...
    public ServerActivity1(Context context, Handler handler) {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (ServerActivity1.this) {
                        switch (mState) {
                            case STATE_LISTEN:
